...
func Test_MainRouter(t *testing.T) {
	...
	initialProxys := `[{"name":"Example 1","isProxy":true,"host":"www.myexample.com","forwardTo":"www.example.com","serve":"","secured":false,"icon":"redeem","rank":"1","iframed":true,"iframepath":"/test","login":"","password":""},{"name":"Example 2","isProxy":false,"host":"www.myexample2.com","forwardTo":"","serve":"../proxy/testdata","secured":false,"icon":"redeem","rank":"2","iframed":false,"iframepath":"","login":"","password":""}]`
	updatedProxysWithSchemes := `[{"name":"Example 1","isProxy":true,"host":"http://www.myexample.com","forwardTo":"www.example.com","serve":"","secured":false,"icon":"redeem","rank":"1","iframed":true,"iframepath":"/test","login":"","password":""},{"name":"Example 2","isProxy":false,"host":"https://www.myexample2.com","forwardTo":"","serve":"../proxy/testdata","secured":false,"icon":"redeem","rank":"2","iframed":false,"iframepath":"","login":"","password":""}]`
